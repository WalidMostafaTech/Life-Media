...
const SkeletonSolutionsWeOffer = () => {
  return (
    <section>
      ...
      <section className="container sectionPadding space-y-2">
        <Skeleton height="h-10" width="w-full" rounded="rounded-full" />
        <Skeleton height="h-10" width="w-1/2" rounded="rounded-full" />
        <Skeleton height="h-10" width="w-1/3" rounded="rounded-full" />
        <Skeleton height="h-10" width="w-1/4" rounded="rounded-full" />
      </section>
    </section>
  );
};

export default SkeletonSolutionsWeOffer;
