...
import { getNewLiveMediaPage } from "../../api/pagesServices";
...
const NewLiveMediaPage = () => {
  const { id } = useParams();

  const { data, isLoading } = useQuery({
    queryKey: ["newLiveMediaPage", id],
    queryFn: () => getNewLiveMediaPage(id),
  });
...
export default NewLiveMediaPage;
